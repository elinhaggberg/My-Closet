// Sets an Edge Function secret (e.g. BACKUP_PASSPHRASE) on the user's
// connected Supabase project, via the Management API (POST
// /v1/projects/{ref}/secrets -- confirmed against Supabase's own OpenAPI
