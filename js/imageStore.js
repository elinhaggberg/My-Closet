...
// (see app.js) -- every existing resolveImageSrc call site (pin cards,
// board grids...) picks up the new prefix automatically, no call-site
// changes needed.
...
// object URL; a prefix registered via registerRemoteResolver is handed off
// to its resolver; anything else (a remote http(s) URL, or a legacy inline
