import { ICON_HOME, ICON_BOARDS, ICON_HEART } from "./icons.js";
...
export function renderTabbar(root, nav, active) {
  ...
  bar.innerHTML = `<div class="tabbar-inner">
    ...
    <button type="button" class="tab-btn" data-tab="wishlist">${ICON_HEART}<span>Wishlist</span></button>
  </div>`;
